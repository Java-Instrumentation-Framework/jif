 ...
 * <p>Description: Tracks Memory allocated & used, displayed in graph form.</p>
...
public class MemoryMonitor_1 extends JPanel
{
  ...
  public MemoryMonitor_1()
  {
    setLayout(new BorderLayout());
    setBorder(new TitledBorder(new EtchedBorder(), "Allocated Memory Monitor"));
  ...
  public class Surface extends JPanel implements Runnable
  {
    ...
    public void run()
    {
      ...
      while (thread == me && isShowing())
      {
        ...
        if (MemoryMonitor_1.dateStampCB.isSelected())
        {
