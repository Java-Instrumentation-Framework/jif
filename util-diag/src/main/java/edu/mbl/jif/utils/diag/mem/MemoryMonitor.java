...
import edu.mbl.jif.utils.diag.IconUtils;
import edu.mbl.jif.utils.diag.IconUtils;
import java.util.*;
import java.awt.*;
...
//  static MemoryMonitor memMon;
    ...
    public static void openInJFrame() {
        ...
        try{
            gcButton.setIcon(IconUtils.loadImageIcon("trash16grn.gif", MemoryMonitor.class));
        } catch(Exception ex) {}
        ...
        try {
            f.setIconImage(IconUtils.loadImageIcon("MemMon.gif", MemoryMonitor.class).getImage());
        } catch(Exception ex) {}
