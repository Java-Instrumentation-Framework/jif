 ...
 * has defines PixelRoiListener
 */

public class ZoomImagePanel
      extends PanelEnclosed
{
   ...
   public ZoomImagePanel (Image _zoomimage, float _zoomMagnification,
...
//                           "pD(" + pD.x + ", " + pD.y + ")  ");
   ...
   //  TEST ====================================================================
   public void test () {
      String image_file_name = ".\\test-images\\Cells.tif";
