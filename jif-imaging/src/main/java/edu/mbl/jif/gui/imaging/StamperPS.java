...
/*
 * 
 *     MouseListenerStamp mListenerStamp = new MouseListenerStamp();
    
    
    public void clearStamps() {
        // stampPts.clear();
        over = new BufferedImage((int) imageDim.getWidth(), (int) imageDim.getHeight(),
                BufferedImage.TYPE_INT_ARGB);
    }
    
    //----------------------------------------------------------------
    class MouseListenerStamp
        ...
        public void mouseExited(MouseEvent e) {
            iPanel.valuePanel.setValuePixel();
            //cursorInPanel = false;
            repaint();
        }
    }
 ...
 * 
 */
public class StamperPS implements ImageViewerPlugin {
    ...
    public StamperPS(ImagePanelZoomable iPane) {
        this.iPane = iPane;
    ...
    public List<AbstractButton> getButtons() {
        ...
        try {
            buttonClearPoints.setIcon(new ImageIcon(StamperPS.class.getResource(
