...
public class DisplayImagePlanar extends JComponent
	 ...
	 */
	public DisplayImagePlanar(PlanarImage im) {
		super();
		source = im;
		initialize();
	 ...
	 */
	public DisplayImagePlanar(int width, int height) {
		super();
		source = null;
